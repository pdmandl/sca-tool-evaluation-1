...
# --------------------------------------------------
# Version cutoff (orthogonal to samples)
# --------------------------------------------------
...
# API versioning, GraphQL web servers
# ------------------------------------------------------------
WEB_MIDDLEWARE_AND_APIS = [
    "Asp.Versioning.Mvc",
    "Asp.Versioning.Mvc.ApiExplorer",
...
# Identity, authentication, tokens, JWT/OIDC, cryptography, key vault, secure configuration
# ------------------------------------------------------------
SECURITY_IDENTITY_AND_CRYPTO = [
    "Azure.Identity",
    "Azure.Security.KeyVault.Administration",
...
# ORMs, relational databases, drivers, migrations, NoSQL and specialty databases
# ------------------------------------------------------------
DATA_DATABASE_AND_ORM = [
    "CassandraCSharpDriver",
    "CouchbaseNetClient",
...
# Queues, buses, streaming, schedulers, background jobs, caching, distributed runtime frameworks
# ------------------------------------------------------------
MESSAGING_JOBS_AND_DISTRIBUTED_SYSTEMS = [
    "ActiveMQ.Artemis.Client",
    "Akka",
...
# Logging, metrics, tracing, APM, profiling, monitoring, and telemetry
# ------------------------------------------------------------
LOGGING_MONITORING_AND_OBSERVABILITY = [
    "App.Metrics",
    "Elastic.Apm.NetCoreAll",
...
# Azure, AWS, Google, and other platform/SaaS SDKs
# ------------------------------------------------------------
CLOUD_AND_PLATFORM_SDKS = [
    "AWSSDK.CloudWatchLogs",
    "AWSSDK.Core",
...
# JSON/YAML/CSV/Protobuf, template engines, text/markup processing, MIME/mail
# ------------------------------------------------------------
SERIALIZATION_TEXT_AND_CONTENT = [
    "AngleSharp",
    "CsvHelper",
...
# PDF, Office, reporting, OCR, barcodes, image and graphics processing
# ------------------------------------------------------------
DOCUMENTS_REPORTING_AND_MEDIA = [
    "BarcodeLib",
    "ClosedXML",
...
# HTTP clients, RPC, gRPC, WebSockets, DNS, SSH, ServiceModel, socket and protocol libraries
# ------------------------------------------------------------
NETWORKING_RPC_AND_PROTOCOLS = [
    "DnsClient",
    "Flurl",
...
# DI containers, mediation, configuration, guard/utility libraries, core infrastructure
# ------------------------------------------------------------
DEPENDENCY_INJECTION_INFRASTRUCTURE_AND_UTILS = [
    "Ardalis.GuardClauses",
    "Ardalis.Specification",
...
# Build, NuGet ecosystem, codegen, CLI frameworks, test/coverage tooling
# ------------------------------------------------------------
BUILD_TOOLING_AND_CLI = [
    "CliWrap",
    "CommandLineParser",
...
# ------------------------------------------------------------
# TESTING_AND_QUALITY
# Test frameworks, mocks, assertions, generators, test helpers
# ------------------------------------------------------------
TESTING_AND_QUALITY = [
    "AutoBogus",
    "AutoFixture",
...
# Search, Elasticsearch, Lucene, geo, device/user-agent analysis
# ------------------------------------------------------------
SEARCH_GEO_AND_ANALYTICS = [
    "DeviceDetector.NET",
    "Elastic.Clients.Elasticsearch",
