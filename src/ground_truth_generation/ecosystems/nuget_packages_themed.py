"""Thematically structured NuGet package list.

This file groups the 500 packages by topical theme so that the list is
...
# Notes
# ------------------------------------------------------------
# - Packages are kept in deterministic order per group.
# - The full list is composed at the end via concatenation.
# - A validation check enforces exactly 500 entries and no duplicates.

# ------------------------------------------------------------
# WEB_MIDDLEWARE_AND_APIS
# Middleware, ASP.NET Core, HTTP pipeline, routing, OpenAPI, API versioning, GraphQL web servers
# ------------------------------------------------------------
WEB_MIDDLEWARE_AND_APIS = [
    "Asp.Versioning.Mvc",
