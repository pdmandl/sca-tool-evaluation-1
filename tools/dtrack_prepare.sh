...
# Test only the DTRACK integration (without temporal evaluation) using a
# pre-generated SBOM and a fixed project name. Example invocation:
#
#   SBOM_PATH=/path/to/dataset.sbom.json \
#   DTRACK_PROJECT_NAME=eval_test_002 \
#   DTRACK_URL=http://localhost:8081 \
#   DTRACK_API_KEY="<your_dtrack_api_key>" \
#     ./tools/dtrack_prepare.sh
# -------------
